...
<div class="card">
  <div class="card-header bg-light">
    <div class="row align-items-center">
      <div class="col">
        <h5 class="mb-0">Overdue Loans ({{ $loans->count() }})</h5>
      </div>
    </div>
  </div>
  <div class="card-body">
                ...
                <form action="{{ route('admin.loan.update', $loan->id) }}" method="POST">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <!-- Loan Term -->
                            <div class="mb-3">
                                <label for="term{{ $loan->id }}" class="form-label">Loan Term (Months)</label>
                                <select class="form-select" id="term{{ $loan->id }}" name="term">
                            ...
                            <div class="mb-3">
                                ...
                                <select name="status" class="form-select" id="status{{ $loan->id }}" required>
                                    ...
                                    <option value="ongoing" {{ old('status', $loan->status) == 'ongoing' ? 'selected' : '' }}>Approved</option>
